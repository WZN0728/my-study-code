...
public class OrderServiceImpl2 implements IOrderService {
    ...
    public DoOrderResponse doOrder(DoOrderRequest doOrderRequest) {
        ...
        doOrderResponse.setCode("版本2    ->       0001    ->     负载均衡");
        doOrderResponse.setData("版本2    ->       已到货    ->     负载均衡");
        System.out.println("版本2    ->       订单已签收:" + doOrderResponse.getName() + "  ->   " + doOrderResponse.getCode() + "    ->     负载均衡   "
